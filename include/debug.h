...
#define LOGERROR(x)         if(_MATRIXRSS_LOGLEVEL_>0) { ESP_EM_PRINT_MARK; ESP_EM_PRINTLN(x); }
#define LOGERROR0(x)        if(_MATRIXRSS_LOGLEVEL_>0) { ESP_EM_PRINT(x); }
...
#define LOGWARN(x)          if(_MATRIXRSS_LOGLEVEL_>1) { ESP_EM_PRINT_MARK; ESP_EM_PRINTLN(x); }
#define LOGWARN0(x)         if(_MATRIXRSS_LOGLEVEL_>1) { ESP_EM_PRINT(x); }
...
#define LOGINFO(x)          if(_MATRIXRSS_LOGLEVEL_>2) { ESP_EM_PRINT_MARK; ESP_EM_PRINTLN(x); }
#define LOGINFO0(x)         if(_MATRIXRSS_LOGLEVEL_>2) { ESP_EM_PRINT(x); }
...
#define LOGDEBUG(x)         if(_MATRIXRSS_LOGLEVEL_>3) { ESP_EM_PRINT_MARK; ESP_EM_PRINTLN(x); }
#define LOGDEBUG0(x)        if(_MATRIXRSS_LOGLEVEL_>3) { ESP_EM_PRINT(x); }
